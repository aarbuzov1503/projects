...
<p style="font-size:32px;">Форма успешно доставлена, эту вкладку можно закрыть. Через <span id="timer"><?php echo $timer; ?></span> секунд будет произведено перенаправление на страницу статуса</p>
...
<script>
  ...
  function countdown() {
    ...
    if (timer <= 0) {
      window.location = 'https://aprogger.ru/project/app/moderate-app/access/send.php'; // перенаправляем на страницу регистрации пользователей
    } else {
